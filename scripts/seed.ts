...
import { part, processDef, processStep, fmeaTemplateRow, controlTemplateRow, gageLibrary, ratingScale, calibrationLink, pfmea, pfmeaRow, controlPlan, controlPlanRow, equipmentLibrary, equipmentErrorProofing, equipmentControlMethods, failureModesLibrary, controlsLibrary } from '@shared/schema';
import { eq } from 'drizzle-orm';

// Comprehensive Automotive Controls Catalog
const AUTOMOTIVE_CONTROLS: Array<{
  name: string;
  type: 'prevention' | 'detection';
  description: string;
  applicableProcesses: string[];
  typicalOccurrenceImpact?: number | null;
  typicalDetectionRating?: number | null;
  msaRequired: boolean;
  msaStatus?: 'approved' | 'planned' | 'failed' | 'not_required' | null;
  gageType?: string | null;
  sampleSizePlan?: string | null;
  frequencyPlan?: string | null;
  effectiveness: 'high' | 'medium' | 'low';
  tags: string[];
  industryStandard?: string | null;
  status: string;
}> = [
  // PREVENTION CONTROLS - Process Parameter Controls
  {
    name: 'Pack pressure monitoring and control',
    type: 'prevention',
    description: 'Closed-loop control system monitoring and adjusting pack pressure during injection molding cycle to prevent short shots and dimensional variation',
    applicableProcesses: ['Injection Molding', 'Insert Molding', 'Overmolding'],
    typicalOccurrenceImpact: 3,
    msaRequired: false,
    effectiveness: 'high',
    tags: ['molding', 'process-control', 'closed-loop'],
    industryStandard: 'AIAG-VDA 2019',
    status: 'active',
  },
  {
    name: 'Melt temperature control system',
    type: 'prevention',
    description: 'Barrel zone temperature PID control with alarms for out-of-range conditions to ensure consistent material flow',
    applicableProcesses: ['Injection Molding', 'Extrusion'],
    typicalOccurrenceImpact: 2,
    msaRequired: false,
    effectiveness: 'high',
    tags: ['molding', 'temperature', 'process-control'],
    status: 'active',
  },
  {
    name: 'Clamp tonnage monitoring',
    type: 'prevention',
    description: 'Real-time clamp force measurement to prevent flash and ensure proper mold closure',
    applicableProcesses: ['Injection Molding', 'Compression Molding'],
    typicalOccurrenceImpact: 2,
    msaRequired: false,
    effectiveness: 'high',
    tags: ['molding', 'process-control'],
    status: 'active',
  },
  {
    name: 'Cavity pressure transducer',
    type: 'prevention',
    description: 'In-mold pressure sensors for real-time quality monitoring and process control',
    applicableProcesses: ['Injection Molding'],
    typicalOccurrenceImpact: 2,
    msaRequired: true,
    msaStatus: 'approved',
    effectiveness: 'high',
    tags: ['molding', 'in-mold', 'process-control'],
    industryStandard: 'AIAG-VDA 2019',
    status: 'active',
  },
  {
    name: 'Tool wear monitoring system',
    type: 'prevention',
    description: 'Automated tool wear tracking with scheduled replacement alerts based on cycle count or measured wear',
    applicableProcesses: ['Machining', 'Turning', 'Milling', 'Drilling'],
    typicalOccurrenceImpact: 3,
    msaRequired: false,
    effectiveness: 'high',
    tags: ['machining', 'tool-management', 'predictive'],
    status: 'active',
  },
  {
    name: 'Coolant flow monitoring',
    type: 'prevention',
    description: 'Flow sensors on each cooling circuit with alarms for low flow conditions',
    applicableProcesses: ['Injection Molding', 'Machining', 'Die Casting'],
    typicalOccurrenceImpact: 2,
    msaRequired: false,
    effectiveness: 'medium',
    tags: ['cooling', 'process-control'],
    status: 'active',
  },
  {
    name: 'Weld current monitoring',
    type: 'prevention',
    description: 'Real-time weld current measurement with adaptive control for consistent weld quality',
    applicableProcesses: ['Resistance Welding', 'Spot Welding', 'Arc Welding'],
    typicalOccurrenceImpact: 2,
    msaRequired: false,
    effectiveness: 'high',
    tags: ['welding', 'process-control'],
    industryStandard: 'AWS D8.9',
    status: 'active',
  },
  {
    name: 'Servo-driven positioning system',
    type: 'prevention',
    description: 'CNC-controlled positioning with encoder feedback for precise part placement',
    applicableProcesses: ['Assembly', 'Machining', 'Welding'],
    typicalOccurrenceImpact: 2,
    msaRequired: false,
    effectiveness: 'high',
    tags: ['positioning', 'servo', 'precision'],
    status: 'active',
  },
  {
    name: 'Torque-controlled fastening',
    type: 'prevention',
    description: 'DC electric tools with torque and angle monitoring for critical fastener applications',
    applicableProcesses: ['Assembly', 'Fastening'],
    typicalOccurrenceImpact: 2,
    msaRequired: true,
    msaStatus: 'approved',
    effectiveness: 'high',
    tags: ['assembly', 'fastening', 'torque'],
    industryStandard: 'VDI/VDE 2862',
    status: 'active',
  },
  {
    name: 'Preventive maintenance program',
    type: 'prevention',
    description: 'Scheduled maintenance based on OEM recommendations with documented intervals',
    applicableProcesses: ['All Manufacturing'],
    typicalOccurrenceImpact: 2,
    msaRequired: false,
    effectiveness: 'medium',
    tags: ['maintenance', 'preventive'],
    industryStandard: 'IATF 16949',
    status: 'active',
  },
  {
    name: 'Statistical Process Control (SPC)',
    type: 'prevention',
    description: 'Real-time control charts with out-of-control action protocols',
    applicableProcesses: ['All Manufacturing'],
    typicalOccurrenceImpact: 2,
    msaRequired: true,
    msaStatus: 'approved',
    ...
    industryStandard: 'AIAG SPC',
    status: 'active',
  },
  {
    name: 'Operator training and certification',
    type: 'prevention',
    description: 'Documented training program with competency verification and periodic recertification',
    applicableProcesses: ['All Manufacturing'],
    typicalOccurrenceImpact: 2,
    msaRequired: false,
    effectiveness: 'medium',
    tags: ['training', 'human-factors'],
    industryStandard: 'IATF 16949',
    status: 'active',
  },
  {
    name: 'Work instruction standardization',
    type: 'prevention',
    description: 'Visual work instructions with key quality points highlighted and accessible at workstation',
    applicableProcesses: ['All Manufacturing', 'Assembly'],
    typicalOccurrenceImpact: 2,
    msaRequired: false,
    effectiveness: 'medium',
    tags: ['documentation', 'standardization'],
    status: 'active',
  },
  {
    name: 'Material certification verification',
    type: 'prevention',
    description: 'Incoming material verification against purchase order and material specification',
    applicableProcesses: ['All Manufacturing', 'Incoming Inspection'],
    typicalOccurrenceImpact: 2,
    msaRequired: false,
    effectiveness: 'high',
    tags: ['material', 'incoming', 'verification'],
    industryStandard: 'IATF 16949',
    status: 'active',
  },
  {
    name: 'FIFO material management',
    type: 'prevention',
    description: 'First-In-First-Out inventory control with lot traceability',
    applicableProcesses: ['All Manufacturing', 'Material Handling'],
    typicalOccurrenceImpact: 2,
    msaRequired: false,
    effectiveness: 'medium',
    tags: ['material', 'traceability', 'inventory'],
    status: 'active',
  },
  {
    name: 'Humidity control system',
    type: 'prevention',
    description: 'Environmental control for moisture-sensitive materials and processes',
    applicableProcesses: ['Injection Molding', 'Electronics Assembly', 'Painting'],
    typicalOccurrenceImpact: 2,
    msaRequired: false,
    effectiveness: 'high',
    tags: ['environmental', 'humidity'],
    status: 'active',
  },
  {
    name: 'Resin drying system with dewpoint monitoring',
    type: 'prevention',
    description: 'Desiccant dryer with continuous dewpoint monitoring and alarms for hygroscopic materials',
    applicableProcesses: ['Injection Molding', 'Extrusion'],
    typicalOccurrenceImpact: 2,
    msaRequired: false,
    effectiveness: 'high',
    tags: ['molding', 'material-prep', 'moisture'],
    status: 'active',
  },
  {
    name: 'Contamination control (clean room)',
    type: 'prevention',
    description: 'Controlled environment with HEPA filtration, gowning, and particle monitoring',
    applicableProcesses: ['Electronics Assembly', 'Painting', 'Medical Device'],
    typicalOccurrenceImpact: 2,
    msaRequired: false,
    effectiveness: 'high',
    tags: ['contamination', 'clean-room'],
    industryStandard: 'ISO 14644',
    status: 'active',
  },
  {
    name: 'Anti-static controls (ESD)',
    type: 'prevention',
    description: 'Grounded workstations, wrist straps, and ionization for static-sensitive components',
    applicableProcesses: ['Electronics Assembly'],
    typicalOccurrenceImpact: 2,
    msaRequired: false,
    effectiveness: 'high',
    tags: ['esd', 'electronics'],
    industryStandard: 'ANSI/ESD S20.20',
    status: 'active',
  },
  {
    name: 'Fixture/pallet verification',
    type: 'prevention',
    description: 'Sensing to verify correct fixture or pallet before operation proceeds',
    applicableProcesses: ['Machining', 'Assembly', 'Welding'],
    typicalOccurrenceImpact: 2,
    msaRequired: false,
    effectiveness: 'high',
    tags: ['poka-yoke', 'fixture'],
    status: 'active',
  },
  {
    name: 'Part presence sensing',
    type: 'prevention',
    description: 'Sensors to verify all components are present before cycle start',
    applicableProcesses: ['Assembly', 'Injection Molding'],
    typicalOccurrenceImpact: 2,
    msaRequired: false,
    effectiveness: 'high',
    tags: ['poka-yoke', 'sensing'],
    status: 'active',
  },
  {
    name: 'Barcode/RFID component verification',
    type: 'prevention',
    description: 'Scan verification of component part numbers before assembly',
    applicableProcesses: ['Assembly'],
    typicalOccurrenceImpact: 2,
    msaRequired: false,
    effectiveness: 'high',
    tags: ['poka-yoke', 'traceability', 'verification'],
    status: 'active',
  },
  {
    name: 'Sequence verification system',
    type: 'prevention',
    description: 'Automated verification that assembly steps occur in correct sequence',
    applicableProcesses: ['Assembly'],
    typicalOccurrenceImpact: 2,
    msaRequired: false,
    effectiveness: 'high',
    tags: ['poka-yoke', 'sequence'],
    status: 'active',
  },
  {
    name: 'Color-coded tooling',
    type: 'prevention',
    description: 'Visual differentiation of tools and fixtures to prevent mix-up',
    applicableProcesses: ['Assembly', 'Machining'],
    typicalOccurrenceImpact: 1,
    msaRequired: false,
    effectiveness: 'medium',
    tags: ['visual', 'poka-yoke'],
    status: 'active',
  },
  {
    name: 'Keyed fixtures (asymmetric locators)',
    type: 'prevention',
    description: 'Physical features that prevent incorrect part orientation',
    applicableProcesses: ['Assembly', 'Machining', 'Welding'],
    typicalOccurrenceImpact: 2,
    msaRequired: false,
    effectiveness: 'high',
  ...
  {
    name: 'Automated dispensing (adhesive/sealant)',
    type: 'prevention',
    description: 'Robotic dispensing with flow rate and pressure monitoring',
    applicableProcesses: ['Assembly', 'Sealing'],
    typicalOccurrenceImpact: 2,
    msaRequired: false,
    effectiveness: 'high',
    tags: ['dispensing', 'automation'],
    status: 'active',
  },
  {
    name: 'Cure oven temperature profiling',
    type: 'prevention',
    description: 'Multi-zone temperature monitoring with recipe validation',
    applicableProcesses: ['Painting', 'Coating', 'Adhesive Curing'],
    typicalOccurrenceImpact: 2,
    msaRequired: false,
    effectiveness: 'high',
    tags: ['curing', 'temperature', 'process-control'],
    status: 'active',
  },
  {
    name: 'Shield gas flow monitoring',
    type: 'prevention',
    description: 'Continuous monitoring of inert gas flow rate for weld protection',
    applicableProcesses: ['Arc Welding', 'MIG Welding', 'TIG Welding'],
    typicalOccurrenceImpact: 2,
    msaRequired: false,
    effectiveness: 'high',
    tags: ['welding', 'gas', 'process-control'],
    status: 'active',
  },
  {
    name: 'Wire feed speed control',
    type: 'prevention',
    description: 'Servo-controlled wire feed with speed monitoring and alarms',
    applicableProcesses: ['MIG Welding', 'Arc Welding'],
    typicalOccurrenceImpact: 2,
    msaRequired: false,
    effectiveness: 'high',
    tags: ['welding', 'process-control'],
  ...
  {
    name: 'Press force monitoring',
    type: 'prevention',
    description: 'Load cell monitoring with force vs. position curve validation',
    applicableProcesses: ['Stamping', 'Pressing', 'Assembly'],
    typicalOccurrenceImpact: 2,
    msaRequired: false,
    effectiveness: 'high',
    tags: ['pressing', 'force-monitoring'],
    status: 'active',
  },
  // DETECTION CONTROLS - Measurement and Inspection
  {
    name: 'CMM dimensional inspection',
    type: 'detection',
    description: 'Coordinate Measuring Machine inspection per sampling plan with GD&T verification',
    applicableProcesses: ['All Manufacturing'],
    typicalDetectionRating: 2,
    msaRequired: true,
    msaStatus: 'approved',
    gageType: 'CMM',
    sampleSizePlan: '5 per lot',
    frequencyPlan: 'Per shift or per lot',
    effectiveness: 'high',
    tags: ['dimensional', 'cmm', 'measurement'],
    industryStandard: 'AIAG MSA',
    status: 'active',
  },
  {
    name: 'Vision system inspection',
    type: 'detection',
    description: 'Automated camera-based inspection for dimensional and cosmetic verification',
    applicableProcesses: ['All Manufacturing', 'Assembly'],
    typicalDetectionRating: 2,
    msaRequired: true,
    msaStatus: 'approved',
    gageType: 'Vision System',
    sampleSizePlan: '100%',
    frequencyPlan: 'Every part',
    effectiveness: 'high',
    tags: ['vision', 'automated', '100-percent'],
    status: 'active',
  },
  {
    name: 'First piece inspection',
    type: 'detection',
    description: 'Full dimensional verification of first production piece after setup',
    applicableProcesses: ['All Manufacturing'],
    typicalDetectionRating: 3,
    msaRequired: true,
    msaStatus: 'approved',
    gageType: 'Various',
    sampleSizePlan: '1',
    frequencyPlan: 'Each setup',
    effectiveness: 'high',
    tags: ['setup', 'first-piece'],
    industryStandard: 'IATF 16949',
    status: 'active',
  },
  {
    name: 'Go/No-Go gage inspection',
    type: 'detection',
    description: 'Attribute gaging for critical dimensions with documented inspection frequency',
    applicableProcesses: ['Machining', 'Stamping', 'Molding'],
    typicalDetectionRating: 3,
    msaRequired: true,
    msaStatus: 'approved',
    gageType: 'Go/No-Go',
    sampleSizePlan: 'Per control plan',
    frequencyPlan: 'Per control plan',
    effectiveness: 'high',
    tags: ['attribute', 'go-no-go'],
    industryStandard: 'AIAG MSA',
    status: 'active',
  },
  {
    name: 'Caliper/micrometer measurement',
    type: 'detection',
    description: 'Manual dimensional measurement with calibrated hand tools',
    applicableProcesses: ['All Manufacturing'],
    typicalDetectionRating: 4,
    msaRequired: true,
    msaStatus: 'approved',
    gageType: 'Hand Tools',
    sampleSizePlan: 'Per control plan',
    frequencyPlan: 'Per control plan',
    effectiveness: 'medium',
    tags: ['manual', 'dimensional'],
    industryStandard: 'AIAG MSA',
    status: 'active',
  },
  {
    name: 'Ultrasonic weld inspection',
    type: 'detection',
    description: 'UT inspection for weld integrity verification',
    applicableProcesses: ['Welding', 'Resistance Welding'],
    typicalDetectionRating: 2,
    msaRequired: true,
    msaStatus: 'approved',
    gageType: 'Ultrasonic',
    sampleSizePlan: 'Per sampling plan',
    frequencyPlan: 'Per sampling plan',
    effectiveness: 'high',
    tags: ['ndt', 'welding', 'ultrasonic'],
    industryStandard: 'AWS D1.1',
    status: 'active',
  },
  {
    name: 'Destructive weld testing',
    type: 'detection',
    description: 'Peel test, cross-section, or chisel test per sampling frequency',
    applicableProcesses: ['Resistance Welding', 'Spot Welding'],
    typicalDetectionRating: 2,
    msaRequired: false,
    gageType: 'Destructive',
    sampleSizePlan: 'Per sampling plan',
    frequencyPlan: 'Start-up and periodic',
    effectiveness: 'high',
    tags: ['destructive', 'welding'],
    industryStandard: 'AWS D8.9',
    status: 'active',
  },
  {
    ...
    type: 'detection',
    description: 'Radiographic inspection for internal defects in castings and welds',
    applicableProcesses: ['Casting', 'Welding'],
    typicalDetectionRating: 2,
    msaRequired: true,
    msaStatus: 'approved',
    gageType: 'X-ray',
    ...
    frequencyPlan: 'Per sampling plan',
    effectiveness: 'high',
    tags: ['ndt', 'x-ray', 'radiographic'],
    industryStandard: 'ASTM E155',
    status: 'active',
  },
  {
    name: 'Dye penetrant inspection',
    type: 'detection',
    description: 'Surface crack detection using fluorescent or visible dye penetrant',
    applicableProcesses: ['Welding', 'Casting', 'Forging'],
    typicalDetectionRating: 3,
    msaRequired: true,
    msaStatus: 'approved',
    gageType: 'Dye Penetrant',
    sampleSizePlan: 'Per sampling plan',
    frequencyPlan: 'Per sampling plan',
    effectiveness: 'high',
    tags: ['ndt', 'surface'],
    industryStandard: 'ASTM E1417',
    status: 'active',
  },
  {
    name: 'Magnetic particle inspection',
    type: 'detection',
    description: 'Surface and near-surface crack detection for ferromagnetic materials',
    applicableProcesses: ['Machining', 'Forging', 'Heat Treatment'],
    typicalDetectionRating: 3,
    msaRequired: true,
    msaStatus: 'approved',
    gageType: 'Magnetic Particle',
    sampleSizePlan: 'Per sampling plan',
    frequencyPlan: 'Per sampling plan',
    effectiveness: 'high',
    tags: ['ndt', 'magnetic'],
    industryStandard: 'ASTM E1444',
    status: 'active',
  },
  {
    name: 'Leak testing (pressure decay)',
    type: 'detection',
    description: 'Pressure decay testing for sealed assemblies',
    applicableProcesses: ['Assembly', 'Sealing'],
    typicalDetectionRating: 2,
    msaRequired: true,
    msaStatus: 'approved',
    gageType: 'Pressure Decay',
    sampleSizePlan: '100%',
    frequencyPlan: 'Every part',
    effectiveness: 'high',
    tags: ['leak-test', '100-percent'],
    status: 'active',
  },
  {
    name: 'Helium leak detection',
    type: 'detection',
    description: 'High-sensitivity helium mass spectrometer leak testing',
    applicableProcesses: ['Assembly', 'Sealing', 'HVAC'],
    typicalDetectionRating: 1,
    msaRequired: true,
    msaStatus: 'approved',
    gageType: 'Helium Mass Spec',
    sampleSizePlan: '100%',
    frequencyPlan: 'Every part',
    effectiveness: 'high',
    tags: ['leak-test', 'helium', 'high-sensitivity'],
    status: 'active',
  },
  {
    name: 'Hardness testing',
    type: 'detection',
    description: 'Rockwell, Brinell, or Vickers hardness measurement per sampling plan',
    applicableProcesses: ['Heat Treatment', 'Machining'],
    typicalDetectionRating: 3,
    msaRequired: true,
    msaStatus: 'approved',
    gageType: 'Hardness Tester',
    sampleSizePlan: 'Per heat treat lot',
    frequencyPlan: 'Per heat treat lot',
    effectiveness: 'high',
    tags: ['material', 'hardness'],
    industryStandard: 'ASTM E18',
    status: 'active',
  },
  {
    name: 'Surface roughness measurement',
    type: 'detection',
    description: 'Profilometer measurement of Ra, Rz, or other surface parameters',
    applicableProcesses: ['Machining', 'Grinding'],
    typicalDetectionRating: 3,
    msaRequired: true,
    msaStatus: 'approved',
    gageType: 'Profilometer',
    sampleSizePlan: 'Per control plan',
    frequencyPlan: 'Per control plan',
    effectiveness: 'high',
    tags: ['surface', 'roughness'],
    industryStandard: 'ISO 4287',
    status: 'active',
  },
  {
    name: 'Coating thickness measurement',
    type: 'detection',
    description: 'Eddy current or magnetic induction measurement of coating/plating thickness',
    applicableProcesses: ['Painting', 'Plating', 'Coating'],
    typicalDetectionRating: 3,
    msaRequired: true,
    msaStatus: 'approved',
    gageType: 'Coating Thickness Gage',
    sampleSizePlan: 'Per control plan',
    frequencyPlan: 'Per control plan',
    effectiveness: 'high',
  ...
  {
    name: 'Color measurement (spectrophotometer)',
    type: 'detection',
    description: 'Quantitative color measurement using spectrophotometer',
    applicableProcesses: ['Painting', 'Molding'],
    typicalDetectionRating: 3,
    msaRequired: true,
    msaStatus: 'approved',
    gageType: 'Spectrophotometer',
    sampleSizePlan: 'Per lot',
    frequencyPlan: 'Per lot',
    effectiveness: 'high',
    tags: ['color', 'appearance'],
    status: 'active',
  },
  {
    name: 'Visual inspection (operator)',
    type: 'detection',
    description: 'Trained operator visual inspection for cosmetic defects',
    applicableProcesses: ['All Manufacturing'],
    typicalDetectionRating: 5,
    msaRequired: false,
    gageType: 'Visual',
    sampleSizePlan: '100%',
    frequencyPlan: 'Every part',
    effectiveness: 'medium',
    tags: ['visual', 'cosmetic', 'manual'],
    status: 'active',
  },
  {
    name: 'Visual inspection with light booth',
    type: 'detection',
    description: 'Visual inspection in controlled lighting environment per master samples',
    applicableProcesses: ['Painting', 'Molding', 'Assembly'],
    typicalDetectionRating: 4,
    msaRequired: false,
    gageType: 'Light Booth',
    sampleSizePlan: '100%',
    frequencyPlan: 'Every part',
    effectiveness: 'medium',
    tags: ['visual', 'cosmetic', 'lighting'],
    status: 'active',
  },
  {
    name: 'Functional test (end-of-line)',
    type: 'detection',
    description: 'Automated functional verification at end of production line',
    applicableProcesses: ['Assembly'],
    typicalDetectionRating: 2,
    msaRequired: true,
    msaStatus: 'approved',
    gageType: 'Functional Tester',
    sampleSizePlan: '100%',
    frequencyPlan: 'Every part',
    effectiveness: 'high',
    tags: ['functional', 'eol', '100-percent'],
    status: 'active',
  },
  {
    name: 'Electrical continuity test',
    type: 'detection',
    description: 'Automated continuity/resistance testing for electrical assemblies',
    applicableProcesses: ['Electronics Assembly', 'Wire Harness'],
    typicalDetectionRating: 2,
    msaRequired: true,
    msaStatus: 'approved',
    gageType: 'Electrical Tester',
    sampleSizePlan: '100%',
    frequencyPlan: 'Every part',
    effectiveness: 'high',
    tags: ['electrical', '100-percent'],
    status: 'active',
  },
  {
    name: 'Hipot (high potential) test',
    type: 'detection',
    description: 'High voltage dielectric withstand testing for electrical safety',
    applicableProcesses: ['Electronics Assembly'],
    typicalDetectionRating: 2,
    msaRequired: true,
    msaStatus: 'approved',
    gageType: 'Hipot Tester',
    sampleSizePlan: '100%',
    frequencyPlan: 'Every part',
    effectiveness: 'high',
    tags: ['electrical', 'safety', '100-percent'],
    status: 'active',
  },
  {
    name: 'Torque verification (audit)',
    type: 'detection',
    description: 'Torque audit using calibrated torque analyzer',
    applicableProcesses: ['Assembly', 'Fastening'],
    typicalDetectionRating: 3,
    msaRequired: true,
    msaStatus: 'approved',
    gageType: 'Torque Analyzer',
    sampleSizePlan: 'Per sampling plan',
    frequencyPlan: 'Per shift',
    effectiveness: 'high',
    tags: ['torque', 'fastening', 'audit'],
    industryStandard: 'VDI/VDE 2862',
    status: 'active',
  },
  {
    name: 'Push-out force testing',
    type: 'detection',
    description: 'Force measurement for press-fit or interference fit verification',
    applicableProcesses: ['Assembly', 'Pressing'],
    typicalDetectionRating: 2,
    msaRequired: true,
    msaStatus: 'approved',
    gageType: 'Force Tester',
    sampleSizePlan: 'Per sampling plan',
    frequencyPlan: 'Start-up and periodic',
    effectiveness: 'high',
    tags: ['force', 'press-fit'],
    status: 'active',
  },
  {
    name: 'Weight verification',
    type: 'detection',
    description: 'Scale measurement to verify component/assembly weight within tolerance',
    applicableProcesses: ['All Manufacturing', 'Assembly'],
    typicalDetectionRating: 3,
    msaRequired: true,
    msaStatus: 'approved',
    ...
    frequencyPlan: 'Every part',
    effectiveness: 'high',
    tags: ['weight', '100-percent'],
    status: 'active',
  },
  {
    name: 'Optical comparator inspection',
    type: 'detection',
    description: 'Profile comparison against master template using magnified projection',
    applicableProcesses: ['Machining', 'Stamping'],
    typicalDetectionRating: 3,
    msaRequired: true,
    msaStatus: 'approved',
    gageType: 'Optical Comparator',
    sampleSizePlan: 'Per sampling plan',
    frequencyPlan: 'Per sampling plan',
    effectiveness: 'high',
    tags: ['optical', 'profile'],
    status: 'active',
  },
  {
    name: 'Height gage measurement',
    type: 'detection',
    description: 'Precision height measurement on surface plate with calibrated height gage',
    applicableProcesses: ['Machining', 'Stamping'],
    typicalDetectionRating: 3,
    msaRequired: true,
    msaStatus: 'approved',
    gageType: 'Height Gage',
    sampleSizePlan: 'Per control plan',
    frequencyPlan: 'Per control plan',
    effectiveness: 'high',
    tags: ['dimensional', 'height'],
    industryStandard: 'AIAG MSA',
    status: 'active',
  },
  {
    name: 'Thread gage inspection',
    type: 'detection',
    description: 'Go/No-Go thread plug or ring gage verification',
    applicableProcesses: ['Machining', 'Fastening'],
    typicalDetectionRating: 3,
    msaRequired: true,
    msaStatus: 'approved',
    gageType: 'Thread Gage',
    sampleSizePlan: 'Per control plan',
    frequencyPlan: 'Per control plan',
    effectiveness: 'high',
    tags: ['thread', 'attribute'],
    status: 'active',
  },
  {
    name: 'Bore gage measurement',
    type: 'detection',
    description: 'Internal diameter measurement using bore gage or ID micrometer',
    applicableProcesses: ['Machining'],
    typicalDetectionRating: 3,
    msaRequired: true,
    msaStatus: 'approved',
    gageType: 'Bore Gage',
    ...
    frequencyPlan: 'Per control plan',
    effectiveness: 'high',
    tags: ['dimensional', 'bore'],
    industryStandard: 'AIAG MSA',
    status: 'active',
  },
  {
    name: 'Roundness measurement',
    type: 'detection',
    description: 'Form measurement using roundness tester with polar chart output',
    applicableProcesses: ['Machining', 'Grinding'],
    typicalDetectionRating: 2,
    msaRequired: true,
    msaStatus: 'approved',
    gageType: 'Roundness Tester',
    sampleSizePlan: 'Per control plan',
    frequencyPlan: 'Per control plan',
    effectiveness: 'high',
    tags: ['form', 'roundness'],
    industryStandard: 'ISO 12181',
    status: 'active',
  },
  {
    name: 'Contour measurement',
    type: 'detection',
    description: 'Profile/contour tracing for complex geometry verification',
    applicableProcesses: ['Machining', 'Grinding'],
    typicalDetectionRating: 2,
    msaRequired: true,
    msaStatus: 'approved',
    gageType: 'Contour Tracer',
    sampleSizePlan: 'Per control plan',
    frequencyPlan: 'Per control plan',
    effectiveness: 'high',
    tags: ['form', 'contour'],
  ...
  },
  {
    ...
    type: 'detection',
    description: 'Non-destructive detection of cracks and material variations',
    applicableProcesses: ['Heat Treatment', 'Machining'],
    typicalDetectionRating: 2,
    msaRequired: true,
    msaStatus: 'approved',
    gageType: 'Eddy Current',
    sampleSizePlan: '100%',
    frequencyPlan: 'Every part',
    effectiveness: 'high',
    tags: ['ndt', 'eddy-current', '100-percent'],
    industryStandard: 'ASTM E376',
    status: 'active',
  },
  {
    name: 'Tensile testing',
    type: 'detection',
    description: 'Destructive testing for ultimate tensile strength and elongation',
    applicableProcesses: ['Heat Treatment', 'Welding', 'Material Verification'],
    typicalDetectionRating: 2,
    msaRequired: false,
    gageType: 'Tensile Tester',
    sampleSizePlan: 'Per lot',
    frequencyPlan: 'Per heat treat lot',
    effectiveness: 'high',
    tags: ['destructive', 'material', 'tensile'],
    industryStandard: 'ASTM E8',
    status: 'active',
  },
  {
    name: 'Impact testing (Charpy/Izod)',
    type: 'detection',
    description: 'Destructive testing for material toughness verification',
    applicableProcesses: ['Heat Treatment', 'Material Verification'],
    typicalDetectionRating: 2,
    msaRequired: false,
    gageType: 'Impact Tester',
    sampleSizePlan: 'Per lot',
    frequencyPlan: 'Per heat treat lot',
    effectiveness: 'high',
    tags: ['destructive', 'material', 'impact'],
    industryStandard: 'ASTM E23',
    status: 'active',
  },
  {
    name: 'Fatigue testing',
    type: 'detection',
    description: 'Cyclic load testing for endurance limit verification',
    applicableProcesses: ['Material Verification', 'Development'],
    typicalDetectionRating: 2,
    msaRequired: false,
    gageType: 'Fatigue Tester',
    sampleSizePlan: 'Per validation',
    frequencyPlan: 'Development/PPAP',
    effectiveness: 'high',
    tags: ['destructive', 'material', 'fatigue'],
    industryStandard: 'ASTM E466',
    status: 'active',
  },
  {
    name: 'Salt spray testing',
    type: 'detection',
    description: 'Accelerated corrosion testing for coating/plating verification',
    applicableProcesses: ['Painting', 'Plating', 'Coating'],
    typicalDetectionRating: 3,
    msaRequired: false,
    gageType: 'Salt Spray Chamber',
    sampleSizePlan: 'Per validation',
    frequencyPlan: 'Per lot or periodic',
    effectiveness: 'high',
    tags: ['corrosion', 'coating'],
    industryStandard: 'ASTM B117',
    status: 'active',
  },
  {
    name: 'Adhesion testing (cross-hatch)',
    type: 'detection',
    description: 'Tape pull adhesion test per ASTM D3359',
    applicableProcesses: ['Painting', 'Coating'],
    typicalDetectionRating: 3,
    msaRequired: false,
    gageType: 'Cross-Hatch Kit',
    sampleSizePlan: 'Per lot',
    frequencyPlan: 'Per lot',
    effectiveness: 'medium',
    tags: ['adhesion', 'coating'],
    industryStandard: 'ASTM D3359',
    status: 'active',
  },
  {
    name: 'Gloss measurement',
    type: 'detection',
    description: 'Surface gloss measurement using gloss meter at specified angle',
    applicableProcesses: ['Painting', 'Molding'],
    typicalDetectionRating: 3,
    msaRequired: true,
    msaStatus: 'approved',
    gageType: 'Gloss Meter',
    sampleSizePlan: 'Per lot',
    frequencyPlan: 'Per lot',
    effectiveness: 'high',
    tags: ['appearance', 'gloss'],
    status: 'active',
  },
  {
    name: 'Customer return/warranty analysis',
    type: 'detection',
    description: 'Analysis of field returns to identify systematic quality issues',
    applicableProcesses: ['All Manufacturing'],
    typicalDetectionRating: 10,
    msaRequired: false,
    frequencyPlan: 'Ongoing',
    effectiveness: 'low',
    tags: ['field', 'warranty', 'reactive'],
    status: 'active',
  },
  {
    name: 'Layered Process Audit (LPA)',
    type: 'detection',
    description: 'Structured multi-level process verification audits',
    applicableProcesses: ['All Manufacturing'],
    typicalDetectionRating: 5,
    msaRequired: false,
    frequencyPlan: 'Per LPA schedule',
    effectiveness: 'medium',
    tags: ['audit', 'process'],
    industryStandard: 'CQI-8',
    status: 'active',
  },
  {
    name: 'Laser scanning/3D scanning',
    type: 'detection',
    description: 'Full surface digitization for comparison to CAD model',
    applicableProcesses: ['All Manufacturing'],
    typicalDetectionRating: 2,
    msaRequired: true,
    msaStatus: 'approved',
    gageType: '3D Scanner',
    sampleSizePlan: 'Per sampling plan',
    frequencyPlan: 'PPAP or periodic',
    effectiveness: 'high',
    tags: ['3d', 'scanning', 'dimensional'],
    status: 'active',
  },
  {
    name: 'CT scanning (computed tomography)',
    type: 'detection',
    description: 'Industrial CT scanning for internal geometry and defect detection',
    applicableProcesses: ['Casting', 'Additive Manufacturing', 'Assembly'],
    typicalDetectionRating: 1,
    msaRequired: true,
    msaStatus: 'approved',
    gageType: 'CT Scanner',
    ...
    frequencyPlan: 'Development/PPAP',
    effectiveness: 'high',
    tags: ['ct', 'ndt', 'internal'],
    status: 'active',
  },
  {
    name: 'In-process SPC monitoring',
    type: 'detection',
    description: 'Real-time control chart monitoring with out-of-control alerts',
    applicableProcesses: ['All Manufacturing'],
    typicalDetectionRating: 3,
    msaRequired: true,
    msaStatus: 'approved',
    gageType: 'Various',
    sampleSizePlan: 'Per control plan',
    frequencyPlan: 'Continuous',
    effectiveness: 'high',
    tags: ['spc', 'statistical', 'real-time'],
    industryStandard: 'AIAG SPC',
    status: 'active',
  },
  {
    name: 'Barcode verification/grade',
    type: 'detection',
    description: 'Barcode quality grading using ANSI/ISO verification standards',
    applicableProcesses: ['Labeling', 'Printing'],
    typicalDetectionRating: 2,
    msaRequired: true,
    msaStatus: 'approved',
    gageType: 'Barcode Verifier',
    sampleSizePlan: 'Per lot',
    frequencyPlan: 'Per lot',
    effectiveness: 'high',
    tags: ['barcode', 'traceability'],
    industryStandard: 'ISO/IEC 15416',
    status: 'active',
  },
];
...
async function seed() {
  ...
  try {
    await db.transaction(async (tx) => {
      ...
      console.log('  → Creating Controls Library...');
      for (const control of AUTOMOTIVE_CONTROLS) {
        await tx.insert(controlsLibrary).values(control).onConflictDoNothing();
      }
      const preventionCount = AUTOMOTIVE_CONTROLS.filter(c => c.type === 'prevention').length;
      const detectionCount = AUTOMOTIVE_CONTROLS.filter(c => c.type === 'detection').length;
      console.log(`  → Seeded ${AUTOMOTIVE_CONTROLS.length} controls (${preventionCount} prevention, ${detectionCount} detection)`);
    });
